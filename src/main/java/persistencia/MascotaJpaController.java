...
public class MascotaJpaController implements Serializable {
    ...
    // CREAMOS NUESTRO PROPIO CONSTRUCTOR QUE CUANDO SE LLAME AL MISMO, CREE EL UN "ADMINISTRADOR DE ENTIDADES"
    public MascotaJpaController() {
        // CUANDO LLAMAMOS AL JPA, CREAMOS UN ADMINISTRADOR DE ENTIDADES, TENIENDO EN CUENTA LAS PROPIEDADES QUE ESTAN EN NUESTRO PERSISTENCE UNIT
        emf = Persistence.createEntityManagerFactory("PeluCaninaPU");
        // ESTE CONSTRUCTOR SE VA A ENCARGAR DE QUE NOSOTROS PODAMOS LLAMAR A CADA UNO DE LOS METODOS QUE TENEMOS ACA EN EL CONTTROLLER
    }
